...
int Helper::isKeyword(string word) {
    static map<string, int> keywords = {
		...
		{"OBJECT", KW_OBJECT}, {"OF", KW_OF}, {"ON", KW_ON}, {"OPERATOR", KW_OPERATOR}, {"OR", KW_OR}, {"PACKED", KW_PACKED}, {"PROCEDURE", KW_PROCEDURE}, {"PROGRAM", KW_PROGRAM}, {"RECORD", KW_RECORD}, {"REPEAT", KW_REPEAT}, {"SET", KW_SET}, {"SHL", KW_SHL}, {"SHR", KW_SHR}, {"THEN", KW_THEN}, 
